    ...
    <div className="pt-10 transition-opacity duration-500 ease-in border-t-2 opacity-100">
      ...
      <div className="flex flex-col gap-12 sm:gap-12 sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <button
            ...
            className="px-8 py-3 text-sm text-white bg-purple active:bg-gray-700"
          >
            ADD TO CART
          </button>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 px-6 py-6 text-sm text-gray-500 border">
          <p>
            Elevate your style with Kleid's thoughtfully designed pieces.
            Crafted from premium materials, our products blend elegance with
            everyday functionality, offering lasting comfort and durability.
          </p>
          <p>
            Whether you're getting ready for a special event or elevating your
            everyday style, Kleid’s quality pieces bring unmatched versatility.
            With timeless designs and a perfect fit, they’re essential additions
            to any wardrobe. Don’t miss the opportunity to own fashion that
            blends elegance with practicality—feel the difference today.
          </p>
        </div>
      </div>
