      ...
      <div className="flex flex-col gap-16 my-10 md:flex-row">
        ...
        <div className="flex flex-col justify-center gap-6 text-gray-600 md:w-2/4">
          <p className="text-justify">
            Welcome to Kleid, where quality and style come together. Our goal
          ...
          <p className="text-justify">
            At Kleid, your satisfaction is our top priority. From browsing our
            ...
            they arrive. Thank you for choosing Kleid—we’re thrilled to be part
            of your style journey.
          </p>
          <b className="text-gray-800">Our Mission</b>
          <p className="text-justify">
            At Kleid, our mission is to empower you to express your unique
          ...
          <p className="text-justify">
            At Kleid, our vision is to become a global leader in fashion,
            recognized for innovative style and exceptional quality. We strive
            to inspire confidence and creativity, making Kleid the preferred
      ...
      <div className="flex flex-col mb-20 text-sm md:flex-row">
        <div className="flex flex-col gap-5 px-10 py-8 border md:px-16 sm:py-20">
          ...
          <p className="text-gray-600 text-justify">
            At Kleid, quality is our priority. Each product is thoughtfully
        ...
        <div className="flex flex-col gap-5 px-10 py-8 border md:px-16 sm:py-20">
          ...
          <p className="text-gray-600 text-justify">
            Kleid offers a seamless shopping experience with effortless
        ...
        <div className="flex flex-col gap-5 px-10 py-8 border md:px-16 sm:py-20">
          ...
          <p className="text-gray-600 text-justify">
            At Kleid, we’re committed to delivering outstanding service. Our
